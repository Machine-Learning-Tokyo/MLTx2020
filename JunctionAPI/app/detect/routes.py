...
def detect():
    ...
    # For data analysis
    emo_count = {"Angry":0, "Disgusted":0, "Fearful":0, "Happy":0, "Neutral":0, "Sad":0, "Surprised":0}
    ...
    if request.method == "POST":
        for (key, f) in (request.files.items()):
            ...
            xs = ['MAN', 'WOMAN']
            ys = []
            data = copy.deepcopy(gender_count)
            ...
            plt.plot(list(xs), ys, 'bo', label='Crowd Count')
